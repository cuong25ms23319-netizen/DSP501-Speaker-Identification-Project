...
First, DSP preprocessing is essential for reliable voice classification. FIR band-pass filtering and pre-emphasis improved signal-to-noise ratio (SNR) and produced a more balanced spectrum, yielding a 37\% accuracy gain over the raw-signal baseline.
